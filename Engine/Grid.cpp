...
Grid::Grid(int w, std::vector<std::vector<int>> v1)
{
...
void Grid::rendergrid(RenderTarget& target)
{
	for (int i = 0; i < this->walls.size(); i++)
	{
		
	
		this->walls[i].setFillColor(sf::Color::Red);
...
void Grid::updateCollision(Entity * entity, const float & dt)
{
